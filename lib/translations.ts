export const translations = {
  ...
  en: {
    ...
    ascension: {
      ...
      premiumDesc: "Upgrade to Premium to unlock the champion quest, skill tree, and fantasy puzzles.",
    ...
    legal: {
      ...
      termsPremiumText: "The Premium offer is a one-time payment granting lifetime access to advanced features (themes, exclusive piece sets, unlimited profiles, full game review, unlimited AI coach). No recurring subscription will be charged.",
