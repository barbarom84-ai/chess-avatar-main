...
export const en = {
    ...
    profileDashboard: {
      ...
      shortcutAvatarsDesc: "Manage your saved bots",
      shortcutGamesDesc: "Archive, stats, and reviews",
      shortcutAscensionDesc: "Champion quest",
      ...
      deleteAccountBody:
        "This cannot be undone: your account, profiles, and related data will be erased. Past PvP games may remain anonymized on the server.",
      deleteAccountConfirm: "Delete permanently",
      deleteAccountCancel: "Cancel",
      deleteAccountError: "Could not delete the account.",
      deleteAccountSuccess: "Account deleted.",
      signInCta: "Sign in",
      signInDesc: "Sign in to manage your profile, friends, and subscription.",
    },
    ...
    collections: {
      ...
      hint:
        "The ⭐ on a card bookmarks an avatar. A collection is a folder: create it, click it to filter, then add avatars with the folder icon.",
      newPlaceholder: "Collection name…",
      create: "Create",
      created: "Collection created",
      createError: "Could not create collection",
      deleted: "Collection deleted",
      empty: "No collections yet. Create one (e.g. “Blitz”, “To study”) then add avatars to it.",
      profiles: "profiles",
      ...
      emptyCollection: "This collection is empty. Add avatars with the folder icon on a card.",
      noFavorites: "No favorites yet. Tap ⭐ on an avatar card.",
      addedToCollection: "Added to {name}",
    ...
    avatarChat: {
      ...
      send: "Send",
      thinking: "Thinking…",
      quotaLeft: "{remaining} / {limit} messages left",
      ...
      suggestions: [
        ...
        "How do you play with Black?",
        "What's your biggest weakness?",
        "Are you aggressive or solid?",
      ],
      reviewSuggestions: [
        "Why this move?",
      ...
      suggestionOpening: "Tell me about {opening}.",
      emojisLabel: "Emojis",
      emojiPieces: "Pieces",
      ...
      emojiBlack: "Black",
      emojiCheck: "Check",
      emojiBrilliancy: "Brilliancy",
      emojiBlunder: "Blunder",
      emojiTrophy: "Trophy",
      emojiFire: "Fire",
      emojiThink: "Think",
    },
    ...
    playOnline: {
      ...
      pendingRematchesTitle: "Rematch invitations",
      pendingRematchesHint:
        "When colors are swapped, the rematch appears here instead of the open games list.",
      pendingRematchesEmpty: "No pending rematch invitations.",
      ...
      takebackOffer: "Take back move",
      takebackAccept: "Allow takeback",
      takebackDecline: "Decline",
      takebackCancel: "Withdraw request",
      opponentOfferedTakeback: "Your opponent asks to undo the last move.",
      ...
      multiGame: {
        gameStarted: "Your opponent joined — the game is starting!",
        opponentMoved: "{name} moved — your turn",
        gameEnded: "Game finished vs {name}",
        switch: "View",
        yourTurn: "Your turn",
      ...
      friendsHint:
        "Add opponents after an online game, then invite them directly from this list.",
      friendsEmpty:
        "Play an online game, then use “Add as friend” on the opponent card to invite them here.",
      inviteFriend: "Invite",
      inviteFriendHint:
        "Creates a game and sends a direct invitation — your friend can accept to start immediately.",
      inviteFriendCreated: "Lobby created — link copied for your friend.",
      friendInviteSent: "Invitation sent to {name}.",
      pendingInviteIncoming: "{name} invited you to play.",
      acceptInvite: "Accept",
      ...
      matchmakingOnlyLive:
        "Automatic opponent search is available for live time controls. For correspondence, an open game is created.",
      matchmakingFailed: "Could not join the matchmaking queue.",
      matchmakingMatched: "Opponent found — starting game!",
      copyLink: "Copy link",
      moveListTitle: "Moves",
      ...
      errors: {
        ...
        moveInProgress: "A move is already being sent.",
        moveAlreadySubmitted: "That move was already played.",
        timeExpired: "Time expired.",
        illegalMove: "That move isn't legal.",
        rateLimited: "Too many requests — please wait a moment.",
        gameOver: "The game is already over.",
        takebackNotAllowed: "Takeback isn't allowed in this position.",
        noMovesToTakeback: "No moves to take back.",
        networkError: "Network error — check your connection.",
        serverError: "Server unavailable — try again shortly.",
        cannotJoin: "You can't join this game.",
        lobbyCancelFailed: "This lobby can't be cancelled.",
        invalidAction: "Invalid action.",
        noOfferToCancel: "Nothing to cancel.",
        noOfferToDecline: "No offer to decline.",
        noDrawToAccept: "No draw offer to accept.",
        drawOfferLimitReached: "Draw offer limit reached (3 per game).",
        noTakebackToAccept: "No takeback offer to accept.",
        gameNotFinished: "The game isn't finished yet.",
        matchmakingUnsupported: "This time control isn't supported for quick play.",
        rematchFailed: "Could not start rematch.",
        joinFailed: "Could not join this game.",
        createFailed: "Could not create the game.",
        updateFailed: "Update failed — please retry.",
        chatClosed: "Chat is closed for this game.",
        chatInvalid: "Invalid message.",
        generic: "Something went wrong. Please try again.",
      },
      connectionStrip: {
        offline: "You're offline — moves may not sync until you're back online.",
        poor: "Unstable connection — syncing in the background.",
        retry: "Retry sync",
      },
      resultModal: {
        titleWin: "Victory",
