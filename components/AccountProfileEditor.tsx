...
import AccountAvatarCropPanel from "@/components/AccountAvatarCropPanel";
  ...
  return (
    ...
    >
      <DialogContent
        className={
          cropping
            ? "bg-slate-900 border-slate-700 text-slate-100 data-[state=open]:animate-none data-[state=closed]:animate-none"
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                <div className="relative h-20 w-20 shrink-0 overflow-hidden rounded-full border-2 border-slate-700 bg-gradient-to-br from-cyan-600 to-blue-800">
                  <AccountAvatar src={avatarUrl} alt={displayName} initials={initials} sizes="80px" />
                </div>
